...
//2017!
Location WAYPOINT[] = {
  Location(-104.981570, 39.804856), //center
  Location(-104.981494, 39.804850),
  Location(-104.981392, 39.804862),
  Location(-104.981325, 39.804833),
  Location(-104.981291, 39.804851),
  Location(-104.981266, 39.804898),
  Location(-104.981240, 39.804959),
  Location(-104.981303, 39.804977),
  Location(-104.981361, 39.804979),
  Location(-104.981401, 39.804949),
  Location(-104.981444, 39.804877),
  Location(-104.981516, 39.804870),
  Location(-104.981601, 39.804856),
  Location(-104.981587, 39.804837),
  Location(-104.981636, 39.804805),
  Location(-104.981733, 39.804800),
  Location(-104.981780, 39.804851),
  Location(-104.981800, 39.804865),
  Location(-104.981769, 39.804916),
  Location(-104.981714, 39.804952),
  Location(-104.981691, 39.804956),
  Location(-104.981621, 39.804940),
  Location(-104.981615, 39.804894),
  Location(-104.981570, 39.804856) //center
};
...
////        Serial.println("adjust");
  ...
  #define COMPASS_MIN 10
  #define COMPASS_MAX 38
  int test_bearing = ((current_bearing - ((COMPASS_MAX+COMPASS_MIN)/2)*360/(COMPASS_MAX-COMPASS_MIN)))+360;
...
//      Serial.print("  Course: "); Serial.println(courseTo);
      ...
      //THG the following 2 lines seem to be wrong, the second line overrides the first...
      float required_compass_bearing = calculate_compass_bearing(diffLon, diffLat);
      ...
      if( angle_diff_abs > compassMax ) {
        compassMax = angle_diff_abs;
      }

      if( angle_diff_abs < compassMin ) {
        compassMin = angle_diff_abs;
      }

      Serial.print("angle_diff_abs: ");
      Serial.print(angle_diff_abs);
      Serial.print(" compassMin: ");
      Serial.print(compassMin);
      Serial.print(" compassMax: ");
      Serial.print(compassMax);
      Serial.print(" test_bearing: ");
      Serial.println(test_bearing);
